...
| 1 | **Layout fluido full-width** — muere el `.wrap` de 72rem; gutters `clamp()`, composición que llena 1920/2560, medida de texto ≤75ch. Base de todo lo demás. QA pasa a 5 anchos (320/768/1280/1920/2560). | **Completada** (fila desactualizada — blueprint P1-01/P1-02 ya ✅) |
| 2 | **Hero nuevo** — nombre como monumento + frase de servicios + asset de firma interactivo (concepto se decide en `/impeccable shape`, P2-01). Se retiran WeeklyPulse, coffee-pulse.json y RotatingWord. | **Completada** (2026-07-09) — asset final: "Density relief" (contornos topográficos, contrato §2.2.2 del blueprint; sustituye a "Signal in the noise", descartado en revisión visual) |
